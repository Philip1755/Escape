...
public class MyButton {
	...
	public MyButton(String text, int screenX, int screenY, int width, int height, int fontSize) {
		this.text = text;
		this.textX = 0;
		this.textY = 0;
	...
	public void render(Graphics2D g) {
		...
		textY = (float) (bounds.getY() + bounds.getHeight() - bounds.getHeight() / 2 + g.getFontMetrics().getHeight() / 4);
